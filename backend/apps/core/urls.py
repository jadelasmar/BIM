...
urlpatterns = [
    ...
    path("operations/removals/", views.module_launcher, name="operations_removals"),
    path("operations/removals/new/", views.module_launcher, name="operations_create_removal"),
    path("operations/removals/<int:pk>/", views.module_launcher, name="operations_removal_detail"),
    ...
    path("suppliers/<int:pk>/", views.module_launcher, name="supplier_detail"),
    path("clients/", views.module_launcher, name="clients"),
    path("clients/new/", views.module_launcher, name="client_new"),
    path("clients/<int:pk>/", views.module_launcher, name="client_detail"),
