...
4. Add Companies before delivery workflows need company/customer references.
5. Add Receiving Records and Delivery Records as operational stock workflows, not invoice/accounting workflows.
6. Plan API endpoints only where the frontend needs real data.
7. Connect future React screens to focused Django APIs as each workflow is built.
...
12. Reports
13. React/Tailwind operational UI and API bridge
14. Figma-to-React implementation
...
Future operational records should use readable internal numbers:
- `RCV-YYYY-0001` for receiving records
- `DLV-YYYY-0001` for delivery records
- `DOC-YYYY-0001` for documents/forms
- `AST-YYYY-0001` for assets where needed
